  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-gray-900 to-black p-4">
      <div className="flex flex-col items-center gap-4 sm:gap-6 md:gap-8 w-full max-w-7xl">
        {/* Terminal-style loading container */}
        <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl p-4 sm:p-5 md:p-6 bg-gray-900/90 border border-gray-700 rounded-xl shadow-2xl">
          {/* Terminal header */}
          <div className="flex items-center gap-2 mb-4 sm:mb-5 md:mb-6 pb-2 sm:pb-3 border-b border-gray-800">
            ...
            <p className="text-gray-400 text-xs sm:text-sm font-mono ml-2 sm:ml-3 md:ml-4 truncate">
              terminal — loading_system
            </p>
          </div>

          {/* Code editor style loading */}
          <div className="font-mono text-xs sm:text-sm md:text-sm">
            <div className="flex items-start mb-3 sm:mb-4">
              <span className="text-blue-400 mr-2 sm:mr-3 md:mr-4 min-w-[20px]">
                1
              </span>
              <span className="text-green-400">$</span>
              <span className="text-gray-300 ml-1 sm:ml-2 truncate">
            ...
            <div className="flex items-start mb-3 sm:mb-4">
              ...
              <div className="flex-1">
                <span className="text-gray-500">// Loading components...</span>
                <div className="w-full bg-gray-800 h-1.5 sm:h-2 rounded-full mt-1 sm:mt-2 overflow-hidden">
                  <div className="bg-gradient-to-r from-blue-500 to-cyan-400 h-full w-3/4 animate-pulse"></div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                <div className="w-1.5 h-4 sm:w-2 sm:h-5 bg-green-500 animate-pulse"></div>
                <span className="text-gray-400 animate-pulse text-xs sm:text-sm">
                  Compiling TypeScript...
                </span>
              </div>
            </div>
        ...
        {/* Tech stack icons animation */}
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-5 lg:gap-6 px-2">
          {["React", "Node.js", "Python", "AWS", "Docker", "Git"].map(
            (tech, index) => (
              <div
                key={tech}
                ...
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gray-800 rounded-lg flex items-center justify-center border border-gray-700 animate-float">
                  <span className="text-gray-300 font-bold text-[10px] sm:text-xs md:text-xs">
                    {tech}
                  </span>
                </div>
              </div>
        ...
        <div className="text-center px-2">
          <p className="text-gray-300 font-mono text-base sm:text-lg md:text-lg mb-1 sm:mb-2">
            <span className="text-green-400">✓</span> Initializing developer
            environment
          </p>
