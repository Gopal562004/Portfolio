export const navLinks = [
  { id: 1, name: "//_ROOT", href: "#home" },
  { id: 2, name: "//_SYS_INFO", href: "#about" },
  { id: 3, name: "//_EXEC_LOGS", href: "#work" },
  { id: 4, name: "//_PING_REQ", href: "#contact" },
];
...
export const myProjects = [
  {
    ...
    texture: "../../public/images/videos/gradify_demo.mp4",
    ...
    spotlight: "../../public/images/spotlight/gradify_bg.png",
    tags: [
      { id: 1, name: "Next.js", path: "../../public/images/logo/next.png" },
      { id: 2, name: "TypeScript", path: "../../public/images/logo/Typescript_logo_2020.svg.png" },
      { id: 3, name: "Gemini AI", path: "../../public/images/logo/gemini.png" },
      { id: 4, name: "TailwindCSS", path: "../../public/images/logo/tailwindcss.png" },
    ],
  },
  {
    ...
    subdesc: "Using MongoDB, Express, React, Node.js, and Tailwind CSS, Zudio offers a seamless shopping experience with real-time updates and secure transactions.",
    ...
    spotlight: "../../public/images/spotlight/zudio_bg.png",
    tags: [
  ...
  },
  {
    ...
    subdesc: "Built using React, Node.js, and MongoDB, Sangam includes features like alumni profiles, event management, and networking functionalities, with a modern and intuitive UI.",
    href: "https://clean-sangam.vercel.app/alumni",
    texture: "../../public/images/videos/sangam_demo.mp4",
    ...
    spotlight: "../../public/images/spotlight/sangam_bg.png",
    tags: [
      { id: 1, name: "React.js", path: "../../public/images/logo/react.png" },
      { id: 2, name: "Node.js", path: "../../public/images/logo/node.png" },
      { id: 3, name: "MongoDB", path: "../../public/images/logo/mongodb.png" },
      { id: 4, name: "Express.js", path: "../../public/images/logo/express.webp" },
    ],
  },
  {
    ...
    subdesc: "Developed using Python and Streamlit, AgriSmart leverages machine learning models to provide AI-driven analysis that optimizes farming practices and enhances agricultural productivity.",
    href: "https://agrivision-focus-on-crop-monitoring-and-weather-forecasting-bm.streamlit.app/",
    texture: "../../public/images/videos/agri_demo.mp4",
    ...
    spotlight: "../../public/images/spotlight/agri_bg.png",
    tags: [
      { id: 1, name: "Python", path: "../../public/images/logo/python.png" },
      { id: 2, name: "Streamlit", path: "../../public/images/logo/streamlit.png" },
      { id: 3, name: "Machine Learning", path: "../../public/images/logo/ml.png" },
      { id: 4, name: "HTML/CSS", path: "../../public/images/logo/html_css.png" },
    ],
  },
  {
    ...
    texture: "../../public/images/videos/makaan4u_demo.mp4",
    ...
    spotlight: "../../public/images/spotlight/makaan4u_bg.png",
    tags: [
      { id: 1, name: "React.js", path: "../../public/images/logo/react.png" },
      { id: 2, name: "Node.js", path: "../../public/images/logo/node.png" },
      { id: 3, name: "MongoDB", path: "../../public/images/logo/mongodb.png" },
  ...
  },
  {
    ...
    subdesc: "Built with React and Firebase, CollegeQuest offers a smooth user experience, allowing students to quickly search for colleges and scholarship opportunities based on their preferences.",
    ...
    spotlight: "../../public/images/spotlight/collegequest_bg.png",
    tags: [
      { id: 1, name: "React.js", path: "../../public/images/logo/react.png" },
      { id: 2, name: "JavaScript", path: "../../public/images/logo/js.png" },
      { id: 3, name: "FireBase", path: "../../public/images/logo/firebase.png" },
    ],
  },
  {
    ...
    subdesc: "Built using the MERN stack, CodeVerse provides a platform where developers can create, like, comment, and share code and projects, with user authentication and responsive design.",
    ...
    spotlight: "../../public/images/spotlight/codeverse_bg.png",
    tags: [
      { id: 1, name: "React.js", path: "../../public/images/logo/react.png" },
      { id: 2, name: "Node.js", path: "../../public/images/logo/node.png" },
      { id: 3, name: "MongoDB", path: "../../public/images/logo/mongodb.png" },
...
export const workExperiences = [
  {
    ...
    title: "Built APIs and server-side logic for exam preparation platform.",
...
export const achievements = [
  ...
  "Always Learning - Continuously updating skills with latest technologies"
];
